...
export default function NuevoJugador2014Page() {
  ...
  const [formData, setFormData] = useState({
    ...
    telefono: "",
    email: "",
    fecha_nacimiento: "2014-", // Pre-llenar con 2014
    altura: "",
    peso: "",
    numero_camiseta: "",
    velocidad_100m: "",
    ...
    observaciones: "",
    categoria: "2014", // Campo fijo para esta categoría
  })
  ...
  const validarFormulario = () => {
    ...
    // Validación específica de fecha para categoría 2014
    if (formData.fecha_nacimiento && !formData.fecha_nacimiento.startsWith("2014")) {
      nuevosErrores.fecha_nacimiento = "El jugador debe haber nacido en 2014"
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Guardando jugador categoría 2014:", formData)

      // Redirigir a la lista de jugadores 2014
      router.push("/jugadores/2014?nuevo=true")
    } catch (error) {
    ...
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ marginBottom: "30px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" }}>
          <div>
            <h1 style={{ fontSize: "32px", color: "#333", margin: "0 0 10px 0" }}>➕ Nuevo Jugador - Categoría 2014</h1>
            <p style={{ color: "#666", margin: 0 }}>Agregar jugador nacido en 2014 al plantel</p>
          </div>
          <Link
            href="/jugadores/2014"
            style={{
      ...
      >
        ...
        {" > "}
        <Link href="/jugadores/2014" style={{ color: "#007bff", textDecoration: "none" }}>
          Categoría 2014
        </Link>
        {" > "}
        <span style={{ fontWeight: "bold" }}>Nuevo Jugador</span>
      </div>
      ...
      >
        <h3 style={{ margin: "0", color: "#1976d2" }}>📅 Categoría 2014</h3>
        <p style={{ margin: "5px 0 0 0", color: "#1565c0", fontSize: "14px" }}>
          Este jugador será registrado en la categoría de nacidos en 2014
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            >
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "20px" }}>
                ...
                <div>
                  <label style={{ display: "block", marginBottom: "5px", fontWeight: "bold", color: "#333" }}>
                    Fecha de Nacimiento (Debe ser 2014) *
                  </label>
                  <input
                    type="date"
                    ...
                    style={{
                      width: "100%",
                      padding: "12px",
                      border: errores.fecha_nacimiento ? "2px solid #dc3545" : "1px solid #ddd",
                      borderRadius: "4px",
                      fontSize: "14px",
                    }}
                  />
        ...
        >
          <div style={{ display: "flex", justifyContent: "center", gap: "15px" }}>
            ...
            >
              {guardando ? "⏳ Guardando..." : "💾 Guardar Jugador 2014"}
            </button>
            <Link
              href="/jugadores/2014"
              style={{
          ...
          <p style={{ margin: "15px 0 0 0", fontSize: "12px", color: "#666" }}>
            * Campos obligatorios | 📅 Categoría: 2014
          </p>
        </div>
      </form>
    </div>
